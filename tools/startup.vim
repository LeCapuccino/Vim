...
function MoveCursor(sense)
	...
	if s:cur == 4
		call setline(s:pos[4][0], s:margin[0] .. ' [•]  Projects ~\documents\projetos\        <c-p>')
	else
...
function StartupStatusLine()
	...
	let l:line = '%#StatusLineColor# Welcome '
	let l:line = l:line .. '%#StatusLineBase#'
	let l:line = l:line .. g:separator[0]
	let l:line = l:line .. '%#StatusLineSep#'
	let l:line = l:line .. g:separator[0]
	let l:line = l:line .. '%#StatusLineRest#'
...
function StartupSyntax()
	...
	syntax keyword StartupPath   appdata local nvim init vim projetos documents
