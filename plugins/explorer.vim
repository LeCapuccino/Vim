...
function SetFileExplorerStatusLineColors()
	let l:color = g:colors[14]

	let l:floor = g:base[2]
	let l:rest  = g:base[1]

	execute 'highlight FileExplorerStatusLineColor guibg=' .. l:color .. ' guifg=' .. l:floor
	execute 'highlight FileExplorerStatusLineBase  guibg=' .. l:floor .. ' guifg=' .. l:color
	execute 'highlight FileExplorerStatusLineSep   guibg=' .. l:rest  .. ' guifg=' .. l:floor
	execute 'highlight FileExplorerStatusLineRest  guibg=' .. l:rest  .. ' guifg=' .. l:color
endfunction
...
function FileExplorerStatusLine(...)
	...
	let l:left = l:left .. '%#FileExplorerStatusLineColor# ' .. l:name .. ' '
	let l:left = l:left .. '%#FileExplorerStatusLineBase#' .. l:separator[0] .. l:mode
	let l:left = l:left .. '%#FileExplorerStatusLineSep#' .. l:separator[0]
	let l:left = l:left .. '%#FileExplorerStatusLineRest# '

	let l:right = l:right .. '%#FileExplorerStatusLineSep#' .. l:separator[1]
	let l:right = l:right .. '%#FileExplorerStatusLineBase#' .. ' ' .. l:progress .. ' '
	let l:right = l:right .. '%#FileExplorerStatusLineBase#' .. l:separator[1]
	let l:right = l:right .. '%#FileExplorerStatusLineColor# ' .. l:line .. ' '
...
function SetFileExplorerColors()
...
local shortkeys = {
	...
	{key = "<space>", cb = action("preview")},
	{key = "<tab>",   cb = action("parent_node")},
